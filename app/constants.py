...
MSG_CARD_ASK_NAME = "Назва картки"
MSG_CARD_ASK_OWNER = "Власник картки"
...
MSG_TTN_ASK_PRODUCTS = "🛍️ Enter ordered products."
MSG_TTN_INVALID_PRODUCTS = "Додайте хоча б один товар. Кожен рядок — один товар."
