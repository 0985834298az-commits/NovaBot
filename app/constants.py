...
BTN_CARD_ADD = "➕ Додати картку вручну"
BTN_CARD_IMPORT = "🔄 Імпортувати картки з Нової Пошти"
BTN_BACK = "⬅️ Назад"
...
CALLBACK_CARD_IMPORT = "card:import"
...
MSG_CARDS_IMPORT_SUCCESS = "✅ Імпортовано {count} карток"
MSG_CARDS_IMPORT_EMPTY = "⚠️ У цьому акаунті Нової Пошти не знайдено карток."
MSG_CARD_LOCAL_FOUND_NO_REF = (
    "⚠️ Картку знайдено локально, але Ref від Нової Пошти відсутній."
)
MSG_CARD_REF_AVAILABLE = "Ref: доступний"
MSG_CARD_REF_MISSING = "Ref: відсутній"
MSG_NO_ACTIVE_PAYMENT_CARD = (
    "❌ Не вибрано активну картку.\n\n"
    "Додайте банківську картку в меню \"💳 Картки\" — "
    "номер картки буде використано для накладеного платежу при створенні ТТН."
)
MSG_CARD_NOT_FOUND_IN_NP = (
    "❌ Картку не знайдено в акаунті Нової Пошти.\n\n"
    "Додайте картку в особистому кабінеті Nova Poshta і повторіть."
)

BTN_NP_ACCOUNT_ACTIVATE = "✅ Зробити активним"
BTN_NP_ACCOUNT_RENAME = "✏️ Перейменувати"
BTN_NP_ACCOUNT_CHANGE_API = "🔑 Змінити API"
BTN_NP_ACCOUNT_EDIT_LIMIT = "📊 Змінити ліміт"
...
CALLBACK_NP_ACCOUNT_EDIT_LIMIT = "np_account:edit_limit"
...
MSG_NP_ASK_MONTHLY_LIMIT = (
    "📊 Введіть місячний ліміт COD (грн).\n\n"
    "Приклад: 30000"
)
...
MSG_NP_ACCOUNT_LIMIT_UPDATED = "✅ Місячний ліміт COD оновлено."
